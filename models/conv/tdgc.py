"""Temporal Distance Gated Convolution"""
...
class TDGC(MessagePassing):
    ...
    def forward(self, x: Tensor, 
        ...
        """Forward step of the TDGC layer.
    ...
    def message(self, x_j: Tensor, edge_attr: OptTensor, edge_weight: OptTensor) -> Tensor:
        ...
        x_j : Tensor
            node features
        edge_attr : OptTensor
            edge attribute (function of the relative distance)
        edge_weight : OptTensor
            edge weight (sign of the relative distance)
