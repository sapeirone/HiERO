...
class SpaceTimeTransformer(nn.Module):
    ...
    def __init__(
        ...
        self.pos_embed = nn.Parameter(torch.zeros(1, self.patches_per_frame + 1, embed_dim))  # remember to take pos_embed[1:] for tiling over time
    ...
    def forward_features(self, x):
        ...
        for blk in self.blocks:
            ...
            x = checkpoint(blk, x, self.einops_from_space, self.einops_to_space, self.einops_from_time, self.einops_to_time, time_n=n, space_f=f, use_reentrant=False)
